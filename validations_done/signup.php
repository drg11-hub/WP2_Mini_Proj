        ...
        <div class="signup-form">
            <form action="db_signup.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <label data-error="wrong" data-success="right" for="defaultForm-pass">Personal Details</label>
                    <div class="row">
                ...
                <div class="form-group">
                    <input type="password" class="form-control" name="pwd1" id="pwd1" placeholder="Password" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required="required">
                </div>
                <div class="form-group">
                    <input type="password" class="form-control" name="pwd2" id="pwd2" placeholder="Confirm Password" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required="required">
                </div>
                <div class="form-group">
